# Vendored `egui-miniquad`

Source: https://github.com/not-fl3/egui-miniquad (master @ `47417e0`).

crates.io `0.16.0` still depends on egui 0.31. Git master already uses
`Context::run_ui` (egui 0.36) but still declares egui 0.35 in Cargo.toml.
This copy pins **egui 0.36** so Zeus shares one egui tree. Replace with
the crates.io crate once it publishes 0.36 support.
