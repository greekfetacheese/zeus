...
pub fn write_connector_session(
   ...
   #[cfg(windows)]
   {
      ...
      // Default ACL is inherited (often Users/Everyone on a shared dir).
      // Replace with an owner-only DACL — Windows analog of 0600.
...
#[cfg(windows)]
fn restrict_file_to_owner(path: &Path) -> Result<(), anyhow::Error> {
