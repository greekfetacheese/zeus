...
use egui::{Align, Align2, Color32, Frame, Grid, Label, Layout, ScrollArea, Slider, Ui, Window, vec2};
use egui_theme::{
   Theme,
   utils::{bg_color_on_hover, bg_color_on_idle, border_on_click, border_on_hover, border_on_idle},
};
      ...
      Window::new("settings_main_ui")
         ...
         .show(ui.ctx(), |ui| {
            ...
            ui.vertical_centered(|ui| {
               ...
               let contacts = button(rich_text("Contacts").size(17.0))
                  .corner_radius(5)
                  .min_size(size);
   ...
   fn contact(&mut self, icons: Arc<Icons>, contact: &Contact, ui: &mut Ui) {
      ui.horizontal(|ui| {
         ...
         ui.vertical(|ui| {
            ...
            if ui
               .selectable_label(false, rich_text(&address).size(12.0))
               .clicked()
            {
