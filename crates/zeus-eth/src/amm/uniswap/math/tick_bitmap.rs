...
#[cfg(test)]
mod test {
    use super::{flip_tick, next_initialized_tick_within_one_word, UniswapV3MathError};
    use alloy_primitives::U256;
    use std::{collections::HashMap, vec};

    pub fn init_test_ticks() -> Result<HashMap<i16, U256>, UniswapV3MathError> {
    ...
    #[test]
    pub fn test_next_initialized_tick_within_one_word_lte_false() -> Result<(), UniswapV3MathError> {
    ...
    #[test]
    pub fn test_next_initialized_tick_within_one_word_lte_true() -> Result<(), UniswapV3MathError> {
        let mut tick_bitmap = init_test_ticks()?;
    ...
    #[test]
    pub fn test_initialized() -> Result<(), UniswapV3MathError> {
        //is false at first
        let mut tick_bitmap: HashMap<i16, U256> = HashMap::new();
    ...
    #[test]
    pub fn test_flip_tick() -> Result<(), UniswapV3MathError> {
