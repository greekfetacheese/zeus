...
sol! {
    #[sol(rpc)]
    ERC20GetBalance,
    "src/utils/abi/ERC20GetBalance.json",
}

sol! {
    #[sol(rpc)]
    GetERC20,
    "src/utils/abi/GetERC20.json",
}

sol! {
    #[sol(rpc)]
    GetERC20Batch,
    "src/utils/abi/GetERC20Batch.json",
}

sol! {
    #[sol(rpc)]
    GetV2PoolsReserves,
    "src/utils/abi/GetV2PoolReserves.json",
}

sol! {
    #[sol(rpc)]
    GetV3Pools,
    "src/utils/abi/GetV3Pools.json",
}

sol! {
    #[sol(rpc)]
    GetV3PoolState,
    "src/utils/abi/Get_V3PoolState.json",
}

sol! {
    #[sol(rpc)]
    GetV4PoolState,
    "src/utils/abi/Get_V4PoolState.json",
}

sol! {
   #[sol(rpc)]
   TickDataAggregatorV4,
   "src/utils/abi/TickDataAggregatorV4.json",
}

sol! {
   #[sol(rpc)]
   TickBitmapFetchV3,
   "src/utils/abi/TickBitmapFetchV3.json",
}

sol! {
   #[sol(rpc)]
   TickDataFetchV3,
   "src/utils/abi/TickDataFetchV3.json",
}
