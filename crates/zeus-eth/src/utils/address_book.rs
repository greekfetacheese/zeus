...
pub fn permit2_contract(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0x000000000022D473030F116dDEE9F6B43aC78BA3")),
...
pub fn eth_usd_price_feed(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0x694AA1769357215DE4FAC081bf1f309aDC325306")),
...
pub fn usdc_usd_price_feed(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0xA2F78ab2355fe2f984D808B5CeE7FD0A93D5270E")),
...
pub fn dai_usd_price_feed(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0x14866185B1962B63C3Ea9E03Bc1da838bab34C19")),
...
pub fn usdc(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238")),
...
pub fn dai(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0x3e622317f8C93f7328350cF0B56d9eD4C620C5d6")),
...
pub fn wbtc(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0x16EFdA168bDe70E05CA6D349A690749d622F95e0")),
...
pub fn uniswap_v4_stateview(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0xe1dd9c3fa50edb962e442f60dfbc432e24537e4c")),
...
pub fn uniswap_v4_pool_manager(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0xE03A1074c86CFeDd5C142C4F04F1a1536e203543")),
...
pub fn universal_router_v2(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0x3A9D48AB9751398BbFa63ad67599Bb04e4BdF98b")),
...
pub fn uniswap_v4_quoter(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0x61B3f2011A92d183C7dbaDBdA940a7555Ccf9227")),
...
pub fn uniswap_v4_nft_position_manager(chain_id: u64) -> Result<Address, anyhow::Error> {
   let chain = ChainId::new(chain_id)?;
   match chain {
      ChainId::Ethereum => Ok(address!("0xbd216513d74c8cf14cf4747e6aaa6420ff64ee9e")),
      ChainId::EthereumSepolia => Ok(address!("0x429ba70129df741B2Ca2a85BC3A2a3328e5c09b4")),
      ChainId::Optimism => Ok(address!("0x3c3ea4b57a46241e54610e5f022e5c45859a1017")),
      ChainId::BinanceSmartChain => Ok(address!("0x7a4a5c919ae2541aed11041a1aeee68f1287f95b")),
      ChainId::Base => Ok(address!("0x7c5f5a4bbd8fd63184577525326123b519429bdc")),
      ChainId::Arbitrum => Ok(address!("0xd88f38f930b7952f2db2432cb002e7abbf3dd869")),
   }
}
...
pub fn uniswap_v3_nft_position_manager(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0x1238536071E1c677A632429e3655c799b22cDA52")),
...
pub fn uniswap_v2_factory(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0xF62c03E08ada871A0bEb309762E260a7a6a880E6")),
...
pub fn uniswap_v2_router(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0xeE567Fe1712Faf6149d80dA1E6934E354124CfE3")),
...
pub fn uniswap_v3_factory(chain_id: u64) -> Result<Address, anyhow::Error> {
   ...
   match chain {
      ...
      ChainId::EthereumSepolia => Ok(address!("0x0227628f3F023bb0B980b67D528571c95c6DaC1c")),
