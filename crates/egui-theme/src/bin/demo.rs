...
use egui::{
   Button, CentralPanel, CollapsingHeader, Color32, ComboBox, Frame, RichText, Slider, Stroke, TextEdit, UiBuilder,
   ViewportCommand,
};

use lib::{Theme, ThemeKind, editor::ThemeEditor, utils};
         ...
         egui::CentralPanel::default()
            ...
            .show_inside(ui, |ui| {
               ui.vertical_centered(|ui| {
                  ...
                  let text_edit = TextEdit::singleline(&mut self.text_edit_text).hint_text("Type something here...");
                  ui.label("TextEdit");
                     ...
                     ComboBox::from_label("ComboBox")
                        ...
                        .show_ui(ui, |ui| {
                           for coffee in &self.coffee_type {
                              if ui
                                 .selectable_label(&self.selected_coffee == coffee, coffee)
                                 .clicked()
                              {
...
fn close_maximize_minimize(ui: &mut egui::Ui) {
   ...
   if is_maximized {
      let maximized_response = ui
         .add(Button::new(
            RichText::new("🗗").size(button_height).color(Color32::WHITE),
         ))
